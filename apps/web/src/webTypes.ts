...
export type CurrentUser = { id:string; username:string; role:string; avatar:UserAvatar };
...
export type Stock = { itemId: string; locationId: string; quantity: number; latestReceivedAt?:string|null };

export type OpenedConsumable={id:string;itemId:string;itemName:string;baseUnit:string;locationId:string;locationName:string|null;batchId:string;batchLabel:string|null;manufacturedDate:string|null;expiryDate:string|null;openedExpiryDate:string|null;quantity:number;openedAt:string};
