...
import { House, Building2, Trees, Warehouse, Castle, Leaf, Star, Package, Apple, Carrot, Beef, Fish, Egg, Milk, Coffee, Wine, CookingPot, Sandwich, Cookie, SprayCan, WashingMachine, Shirt, Pill, HeartPulse, Wrench, Cable, Battery, BookOpen, PawPrint, Bath, type LucideIcon } from "lucide-react";
...
export const itemIconIds = ["package", "apple", "carrot", "beef", "fish", "egg", "milk", "coffee", "wine", "cooking", "sandwich", "cookie", "spray", "laundry", "shirt", "pill", "health", "wrench", "cable", "battery", "book", "pet", "bath", "leaf"];
...
export function itemIconFor(item: { icon?: string | null; name: string; category?: string | null }) {
  ...
  for (const [pattern, id] of [[/鸡蛋|鸭蛋|蛋类/, "egg"], [/牛奶|酸奶|乳品/, "milk"], [/洗衣/, "laundry"], [/肉|香肠|熏肠/, "beef"], [/鱼|虾|水产/, "fish"], [/水果|苹果|香蕉/, "apple"], [/蔬菜/, "carrot"], [/酒/, "wine"], [/饮|茶|咖啡|水|可乐/, "coffee"], [/零食|饼干/, "cookie"], [/即食|面包|泡面/, "sandwich"], [/清洁/, "spray"], [/洗浴|沐浴|洗发/, "bath"], [/药/, "pill"], [/健康/, "health"], [/衣物/, "shirt"], [/工具/, "wrench"], [/电池/, "battery"], [/电器/, "cable"], [/文具|书/, "book"], [/宠物/, "pet"], [/食品|生鲜/, "cooking"]] as [RegExp, string][]) if (pattern.test(text)) return id;
  return "package";
}
