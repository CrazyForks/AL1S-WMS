...
const unitLabels = {
  ...
  "en-US": {个:"unit(s)",瓶:"bottle(s)",盒:"box(es)",包:"pack(s)",箱:"carton(s)",袋:"bag(s)",罐:"can(s)",桶:"bucket(s)",卷:"roll(s)",支:"piece(s)",根:"piece(s)",条:"strip(s)",片:"slice(s)",张:"sheet(s)",块:"piece(s)",颗:"piece(s)",把:"bunch(es)",双:"pair(s)",套:"set(s)",份:"serving(s)",克:"g",市斤:"jin",千克:"kg",毫升:"mL",升:"L",厘米:"cm",米:"m",其他:"other",件:"piece(s)"},
} as const;
